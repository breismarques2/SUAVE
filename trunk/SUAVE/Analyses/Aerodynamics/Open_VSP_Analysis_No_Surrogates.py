...
#from SUAVE.Methods.Aerodynamics.VSP_inviscid_No_Surrogates import VSP_inviscid_No_Surrogates

# ----------------------------------------------------------------------
#  Analysis
# ----------------------------------------------------------------------
## @ingroup Analyses-Aerodynamics
class Open_VSP_Analysis_No_Surrogates(Markup):
    ...
    def __defaults__(self):
        ...
        #compute.lift.inviscid              = VSP_inviscid_No_Surrogates()
