...
from SUAVE.Methods.Aerodynamics import VSP_Analysis_MLP_Tecnam

# ----------------------------------------------------------------------
#  Analysis
# ----------------------------------------------------------------------
## @ingroup Analyses-Aerodynamics
class Open_VSP_Analysis_Tecnam(Markup):
    ...
    def __defaults__(self):
        ...
        compute.lift.inviscid              = VSP_Analysis_MLP_Tecnam.VSP_Analysis_MLP_Tecnam()
