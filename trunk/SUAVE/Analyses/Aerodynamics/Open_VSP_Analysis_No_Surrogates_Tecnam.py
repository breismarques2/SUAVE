...
from SUAVE.Methods.Aerodynamics import VSP_inviscid_No_Surrogates_Tecnam

# ----------------------------------------------------------------------
#  Analysis
# ----------------------------------------------------------------------
## @ingroup Analyses-Aerodynamics
class Open_VSP_Analysis_No_Surrogates_Tecnam(Markup):
    ...
    def __defaults__(self):
        ...
        compute.lift.inviscid              = VSP_inviscid_No_Surrogates_Tecnam.VSP_inviscid_No_Surrogates_Tecnam()
        ...
        compute.drag.compressibility.wings.wing    = Common.Drag.compressibility_drag_wing_oldversion
        compute.drag.compressibility.total         = Common.Drag.compressibility_drag_wing_total_oldversion        
